  ...
  return (
    <div className="border-b border-[var(--border)] bg-[var(--card)] p-5">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 items-end">
        ...
        <button 
          onClick={onReset}
          className="flex h-10 items-center justify-center gap-2 rounded-lg border border-[var(--border)] bg-[var(--card-soft)] px-5 text-[10px] font-bold uppercase tracking-widest text-[var(--muted)] hover:bg-[var(--card)] hover:text-[var(--text)] hover:border-[var(--primary)]/30 transition-all active:scale-95 whitespace-nowrap"
        >
